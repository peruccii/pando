...
const ptBR: TranslationTable = {
  ...
  'settings.terminal.description': 'Ajuste a aparência do terminal com uma fonte instalada na sua máquina.',
  'settings.terminal.fontFamily': 'Fonte do terminal',
  'settings.terminal.fontFamily.description': 'Escolha uma família de fonte instalada localmente. Fontes monoespaçadas são recomendadas.',
  'settings.terminal.fontFamily.loading': 'Carregando fontes instaladas...',
  'settings.terminal.fontFamily.fallback': 'Não foi possível listar as fontes instaladas. Usando opções padrão.',
  'settings.terminal.cursorStyle': 'Tipo de cursor',
  'settings.terminal.cursorStyle.description': 'Defina o formato do cursor para todos os terminais.',
  'settings.terminal.cursorStyle.line': 'Linha',
  'settings.terminal.cursorStyle.block': 'Bloco',
  'settings.terminal.cursorStyle.underline': 'Sublinhado',
  'settings.terminal.preview.title': 'Preview',
  'settings.terminal.preview.description': 'Pré-visualização em tempo real usando a fonte e o zoom atuais do terminal.',
...
const enUS: TranslationTable = {
  ...
  'settings.terminal.title': 'Terminal',
  'settings.terminal.description': 'Customize terminal typography with a font installed on your machine.',
  'settings.terminal.fontFamily': 'Terminal font',
  'settings.terminal.fontFamily.description': 'Pick a locally installed font family. Monospaced fonts are recommended.',
  'settings.terminal.fontFamily.loading': 'Loading installed fonts...',
  'settings.terminal.fontFamily.fallback': 'Could not list installed fonts. Using default options.',
  'settings.terminal.cursorStyle': 'Cursor style',
  'settings.terminal.cursorStyle.description': 'Set the cursor shape for all terminals.',
  'settings.terminal.cursorStyle.line': 'Line',
  'settings.terminal.cursorStyle.block': 'Block',
  'settings.terminal.cursorStyle.underline': 'Underline',
  'settings.terminal.preview.title': 'Preview',
  'settings.terminal.preview.description': 'Live preview using the current terminal font and zoom.',
